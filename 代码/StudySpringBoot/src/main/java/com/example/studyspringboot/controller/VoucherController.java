...
public class VoucherController {
    ...
    String port;
    // 存储头像文件的路径
    private static final String ROOT_PATH = System.getProperty("user.dir") + File.separator + "voscher";
    ...
    public Result uploadHeadPhoto(MultipartFile file) throws IOException {
        ...
        // 返回头像文件的URL
        String url = "http://" + ip + ":" + port + "/voucher/download/" + newFilename;
        ...
        if (rootDirectory.exists() && rootDirectory.isDirectory()) {
            ...
            for (File file : files) {
                if (file.isFile()) {
                    ...
                    String url = "/voucher/download/" + filename;
